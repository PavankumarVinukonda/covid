      ...
      <div className="all-states-table" testid="stateWiseCovidDataTable">
        <div className="table-header">
          <div className="state-name-heading">
            ...
            >
              <img src="https://res.cloudinary.com/dvcurljig/image/upload/v1639274244/Covid19DashBoard/sort_r2z4a5.svg" 
              alt='low to high' className="order-icon" />
            </button>
            <button
              className="order"
              type="button"
            ...
            >
              <img src="https://res.cloudinary.com/dvcurljig/image/upload/v1639274340/Covid19DashBoard/sort_irbmaz.svg" 
              alt="high to low" className="order-icon" />
            </button>
          </div>
      ...
      <div className="main-container">
        ...
        <div className="container">
          <div className="search-container">
           <img src="https://res.cloudinary.com/dvcurljig/image/upload/v1639580111/Covid19DashBoard/search_ysypmh.svg" 
